// Methods taken/modified from Go stdlib crypto/rsa internal
// Orignal license applies to this file
...
func pssEMSAPSSEncode(mHash []byte, pub *rsa.PublicKey, salt []byte, hash hash.Hash) ([]byte, error) {
...
// PSS signature.
func pssNewSalt(rand io.Reader, pub *rsa.PublicKey, hash crypto.Hash, opts *rsa.PSSOptions) ([]byte, error) {
